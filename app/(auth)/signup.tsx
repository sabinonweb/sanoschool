                    ...
                    <Animated.View style={animatedStyle} className='h-full flex flex-col '>
                        ...
                        <View className='my-auto '>
                            ...
                            <View className='p-5 mt-4'>
                                <SubmitButton label={"Create Account"} action={() => { router.replace('main') }} />
                            </View>
                        ...
                        <View className='flex flex-col mt-auto'>
                            <Pressable onPress={() => router.push('/auth/login')} className=' mt-auto border-t border-t-gray-200 py-5 mx-14'>
