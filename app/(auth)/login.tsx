            ...
            <SafeAreaView className='flex-1 flex flex-col bg-secondary'>
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <Animated.View style={animatedStyle} className='h-full flex flex-col '>
                        <View>
                            <Pressable className='px-6 w-20 mt-4' onPress={() => router.push("/")}>
                        ...
                        <View className='my-auto '>
                            ...
                            <View className='p-5 mt-4'>
                                <SubmitButton label={"Login"} action={() => { signIn() }} />
                            </View>
                            <Pressable onPress={() => router.push('/reset')} className=''>
                        ...
                        <View className='flex flex-col mt-auto'>
                            <Pressable onPress={() => router.push('/signup')} className=' mt-auto border-t border-t-gray-200 py-5 mx-14'>
